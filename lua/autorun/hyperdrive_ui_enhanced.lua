...
function HYPERDRIVE.UI.GetShipStatus(engine)
    ...
    if HYPERDRIVE.SpaceCombat2 then
        status.sc2 = {
            gyropod = HYPERDRIVE.SpaceCombat2.FindGyropod and IsValid(HYPERDRIVE.SpaceCombat2.FindGyropod(engine)),
            shipCore = HYPERDRIVE.SpaceCombat2.FindShipCore and IsValid(HYPERDRIVE.SpaceCombat2.FindShipCore(engine)),
        }
    ...
    if HYPERDRIVE.Spacebuild and HYPERDRIVE.Spacebuild.Enhanced then
        status.sb3 = {
            shipCore = HYPERDRIVE.Spacebuild.Enhanced.FindShipCore and IsValid(HYPERDRIVE.Spacebuild.Enhanced.FindShipCore(engine)),
        }
