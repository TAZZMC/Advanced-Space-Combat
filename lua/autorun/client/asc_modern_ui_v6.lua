...
function ASC.UI.GetColors()
    return ASC.UI.Config.Colors[ASC.UI.State.CurrentTheme] or ASC.UI.Config.Colors.DarkSpace
end
...
function ASC.UI.Initialize()
    ...
    -- Set default theme
    ASC.UI.SetTheme("DarkSpace")
    
    print("[ASC UI] Modern UI system initialized with " .. ASC.UI.State.CurrentTheme .. " theme")
end
...
hook.Add("InitPostEntity", "ASC_UI_Initialize", function()
    timer.Simple(2, ASC.UI.Initialize)
end)
